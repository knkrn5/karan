...
const AboutMe = () => {
  return (
    <div className="card shadow-[0px_4px_16px_px_#367E08] h-[400px] w-[280px] group gap-[0.5em] mx-auto m-4 rounded-[1.5em] relative flex justify-end flex-col p-[1.5em] z-[1] overflow-hidden">
      <div className="absolute top-0 left-0 h-full w-full bg-[#111111]" />
      <img
        src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80"
        alt="yoo"
      ...
      <div className="container text-white z-[2] relative font-nunito flex flex-col gap-[0.5em]">
        ...
        <div className="flex justify-left items-center h-fit w-full gap-2">
          <div className="flex justify-center gap-2 p-2 bg-black rounded-lg">
            <Link
              to="#"
              className="text-white hover:text-red-500 transition duration-400 ease-in-out"
            >
              <svg
