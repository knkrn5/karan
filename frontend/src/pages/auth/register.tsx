    ...
    <>
      <div className={`bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 my-4 w-full max-w-md transition-all duration-500 ease-out ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <button
            type="submit"
            className={`${isSubmitting ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'} text-white font-semibold py-2 px-4 rounded-lg w-full flex justify-center items-center`}
