...
export default function CBLoginMsg() {
  return (
    <div className={` absolute bottom-[40%] right-2 mt-2`}>
      <div className="bg-white dark:bg-gray-800 p-5 mx-8 rounded-lg shadow-lg border-2  border-yellow-500 dark:border-yellow-700 max-w-sm">
