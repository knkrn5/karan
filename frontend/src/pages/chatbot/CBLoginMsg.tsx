...
interface CBLoginMsgProps {
  readonly CBLoginMsgStyling: string;
}

export default function CBLoginMsg({ CBLoginMsgStyling }: CBLoginMsgProps) {
  return (
    <div className={`${CBLoginMsgStyling}`}>
      <div className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 max-w-sm">
        ...
        <div className="mb-4">
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">
            Please log in to use chatbot and access all features.
          </p>
        </div>
