export function BlogSkeletonLoading() {
  return (
    <div className="h-80 w-full sm:w-64 flex flex-col gap-3 rounded-xl shadow-2xl transition-transform duration-300 bg-gray-100 dark:bg-gray-800 overflow-hidden animate-shimmer">
